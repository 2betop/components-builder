            ...
            return new Promise(function(resolve, reject) {
                gitlab.projects.repository.showBranch(project.id, 'master', function(ret) {
                    ...
                    if (!ret) {
                        ...
                        var readme = path.join(dir, '_info.md');
                        ...
                        var command = 'git init && git add _info.md && git commit -m "init" && git remote add origin ' +project.http_url_to_repo + ' && git push -u origin master';
                        console.log(command);
                            ...
                            gitlab.projects.repository.showFile(project.id, {
                                ...
                                if (ret) {
                                    ...
                                    gitlab.projects.repository.updateFile({
                                        ...
                                        branch_name: 'master',
                                        encoding: 'base64',
                                        content: read(file.absolute).toString('base64'),
                                        commit_message: 'by robot',
                                    }, function(ret) {
